...
const styles: Record<string, string> = {
  ...
  DEPOSIT_PENDING: "border border-amber-500/30 bg-amber-500/15 text-amber-200",
  DEPOSIT_PAID: "border border-emerald-500/30 bg-emerald-500/15 text-emerald-200",
  FINAL_PAYMENT_PENDING: "border border-amber-500/30 bg-amber-500/15 text-amber-200",
  FULLY_PAID: "border border-emerald-500/30 bg-emerald-500/15 text-emerald-200",
