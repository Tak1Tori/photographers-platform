    ...
    <section className="hero-light-on relative overflow-hidden border-b border-border bg-background">
      ...
      <div className="container relative flex min-h-[620px] items-center justify-center py-16 md:min-h-[680px] md:py-24">
        <div className="relative z-20 mx-auto max-w-5xl text-center">
          <div className="hero-light-item hero-light-item-1 mb-6 inline-flex items-center gap-2 rounded-md border border-border bg-card/80 px-3 py-2 text-sm text-muted-foreground shadow-sm shadow-emerald-950/30 backdrop-blur">
            <Sparkles className="size-4 text-accent" aria-hidden="true" />
            Фотосессия в несколько шагов
          </div>
          <h1 className="hero-light-item hero-light-item-2 text-5xl font-semibold leading-[1.02] tracking-normal md:text-7xl lg:text-8xl">
            Забронируйте фотосессию под ключ
          </h1>
          <p className="hero-light-item hero-light-item-3 mx-auto mt-6 max-w-2xl text-lg leading-8 text-muted-foreground">
          ...
          <div className="hero-light-item hero-light-item-4 mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          ...
          <div className="hero-light-item hero-light-item-5 mx-auto mt-12 grid max-w-2xl grid-cols-3 gap-3 border-t border-border/70 pt-6 text-left">
            <div>
